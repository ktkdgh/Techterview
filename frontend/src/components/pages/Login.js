                ...
                <div className='login-body'>
                    ...
                    <div className="logInImage">
                        <div className="kakaoImage">
                            <a href='http://localhost:8000/auth/kakao'><img src={require("../images/kakao_login.png")} alt="login" onClick={this.myfunction} /></a>
                        </div>
                        <div className="googleImage">
                            <a href='http://localhost:8000/auth/google'><img src={require("../images/google_login.png")} alt="login" onClick={this.myfunction} /></a>
                        </div>
                    </div>
                </div>
            </div>
